...
import com.mycompany.project_tic_tac_toe.UserRegistration;
...
public class TicTocGUI extends java.awt.Frame {
    ...
    private void initComponents() {
        ...
        a1.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a2.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a3.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a6.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a5.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a4.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a9.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a8.setBackground(new java.awt.Color(135, 206, 250));
        ...
        a7.setBackground(new java.awt.Color(135, 206, 250));
        ...
        ps1.setBackground(new java.awt.Color(0, 0, 0));
        ...
        ps2.setBackground(new java.awt.Color(0, 0, 0));
        ps2.setEnabled(false);
        ps2.setFont(new java.awt.Font("Dialog", 1, 75)); // NOI18N
        ps2.setForeground(new java.awt.Color(255, 255, 255));
    ...
    void condition() {
        if ((con[0] == 0 && con[1] == 0 && con[2] == 0) || (con[3] == 0 && con[4] == 0 && con[5] == 0) || (con[6] == 0 && con[7] == 0 && con[8] == 0) || (con[0] == 0 && con[3] == 0 && con[6] == 0) || (con[1] == 0 && con[4] == 0 && con[7] == 0) || (con[2] == 0 && con[5] == 0 && con[8] == 0) || (con[0] == 0 && con[4] == 0 && con[8] == 0) || (con[2] == 0 && con[4] == 0 && con[6] == 0)) {
            ...
            psc1++;
            ps1.setText("" + psc1);
            userRegistration.storeScore(this.playerId, psc1);
            win();
            // Get total score
            int total = UserRegistration.getUserTotalScore(playerId);

            // Show in dialog
            JOptionPane.showMessageDialog(this, "Game Over! Your total score is: " + total);
            stop();
            ...
            psc2++;
            ps2.setText("" + psc2);
            userRegistration.storeScore(this.playerId, psc2);
            win();
            int total = UserRegistration.getUserTotalScore(playerId);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicTocGUI(-1).setVisible(true);
            }
        });
    }
